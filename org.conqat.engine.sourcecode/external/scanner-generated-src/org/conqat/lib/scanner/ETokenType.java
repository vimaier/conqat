...
public enum ETokenType {
		...
		ENDDO(ETokenClass.KEYWORD),
			/** Token PHP_BEGIN of class SPECIAL */
		PHP_BEGIN(ETokenClass.SPECIAL),
		...
		OVERLOADS(ETokenClass.KEYWORD),
			/** Token PHP_END of class SPECIAL */
		PHP_END(ETokenClass.SPECIAL),
		...
		BYTE(ETokenClass.KEYWORD),
			/** Token PHP_VARIABLE of class IDENTIFIER */
		PHP_VARIABLE(ETokenClass.IDENTIFIER),
		...
		CONNECTED(ETokenClass.KEYWORD),
			/** Token ASYNC of class OPERATOR */
		ASYNC(ETokenClass.OPERATOR),
		...
		END_RETURN(ETokenClass.KEYWORD),
			/** Token PHP_INSTANCE_CALL of class OPERATOR */
		PHP_INSTANCE_CALL(ETokenClass.OPERATOR),
		...
		DATAINFO(ETokenClass.KEYWORD),
			/** Token MULTIPLE_EOL of class SPECIAL */
		MULTIPLE_EOL(ETokenClass.SPECIAL),
		...
		ATTENTION(ETokenClass.KEYWORD),
			/** Token SENTINEL of class SPECIAL */
		SENTINEL(ETokenClass.SPECIAL),
		...
		FETCHABLE(ETokenClass.KEYWORD),
			/** Token PHP_HEREDOC of class LITERAL */
		PHP_HEREDOC(ETokenClass.LITERAL),
		...
		NO_ZERO(ETokenClass.KEYWORD),
			/** Token PHP_DIRECT_OUTPUT of class SPECIAL */
		PHP_DIRECT_OUTPUT(ETokenClass.SPECIAL),
		...
		NOT(ETokenClass.OPERATOR),
			/** Token EOF of class SPECIAL */
		EOF(ETokenClass.SPECIAL),
		...
		IMPORT(ETokenClass.KEYWORD),
			/** Token EOL of class SPECIAL */
		EOL(ETokenClass.SPECIAL),
		...
		FORTRAN(ETokenClass.KEYWORD),
			/** Token PHP_STATIC_CALL of class OPERATOR */
		PHP_STATIC_CALL(ETokenClass.OPERATOR),
