 ...
 * <tt>/local/conqat-root/lib/org.conqat.lib.scanner/grammars/mtext.flex</tt>
 */
class MTextScanner implements ILenientScanner {
  ...
  /* user code: */
	 ...
	 * ETX EXP FIELDTYPE FIXME FLG FON FOREACH FRM FTN FWD GET GOT GRF HDR HYP IF
	 * IFN IMAGE IMG INC IP KEY LAB LAYOUT LEN LIN LNA LOC LOG LOW MAX MNT MODEL MOV
	 * MSG MSK MUL NDL NEW NGT NOT OCL OR ORN PAG PAR PFR PGM PLAINTEXT POS PRO
	 * PRT PSZ PUT PWD PWI RGB ROW SDA SECTION SERIAL SET SIN SIZ SLN SPC SPLIT
	 * SQR STF STG STK STR STYLE SUB SWITCH SYN TAB TABLE TABLEFOOTER
	 * TABLEHEADER TCW TEXTFRAME TODO TOP TRT TSP TXL TXT TXW UCT USES WATERMARK
	 * WHILE WITH XPL ZON
	 */
