 ...
 * <tt>/local/conqat-root/lib/org.conqat.lib.scanner/grammars/unicode.flex</tt>
 */
public final class UnicodeEscapes extends FilterReader {
  ...
  private void markUnicodeEscape () {
  	// offset of unicode escape in this stream
    int offset = zzMarkedPos-1;
    ...
    // "fat" characters, which are exactly 6-1 characters too wide
  	fatCharacterOffsets.add(offset - 5 * fatCharacterOffsets.size());
  }
