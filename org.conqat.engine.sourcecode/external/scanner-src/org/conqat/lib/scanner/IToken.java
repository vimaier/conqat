 ...
 * @ConQAT.Rating GREEN Hash: 60D561E4B15C51433A1CCB18ACA96FC8
 */
public interface IToken {
	...
	/**
	 * Get the number of characters before the and of this token in the text
	 * (i.e. the index of the last character, inclusive).
	 */
