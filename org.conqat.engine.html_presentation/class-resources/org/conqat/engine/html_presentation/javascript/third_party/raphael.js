...
//FIX: arrowhead color was always the color of the last painted arrow
...
(function () {
	...
	/** MODIFIED: Added three args to silence closure compiler. 
	 * @param {*} first
	 * @param {*=} __arg1
	 * @param {*=} __arg2
	 * @param {*=} __arg3
	 */
    function R(first, __arg1, __arg2, __arg3) {
