...
/**
 * This processor filters any nodes which are not part of at least one cycle.
 * 
 ...
 * @version $Rev: 35147 $
 * @ConQAT.Rating GREEN Hash: D4D30C9FC38E5F6FC3D4356E5999CBD4
 */
@AConQATProcessor(description = "This processor removes any vertices which are not part of "
		+ "at least one (directed) cycle.")
public class NotInCycleFilter extends ConQATPipelineProcessorBase<ConQATGraph> {
