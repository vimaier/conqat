 ...
 * @version $Rev: 41751 $
 * @ConQAT.Rating GREEN Hash: 65D53DD4C5E21CB4E9D3612775323625
 */
@SuppressWarnings("unused")
@AConQATProcessor(description = "desc")
public class ProcessorWithDefaultPipeline implements IConQATProcessor {

	/** Test method. */
	@AConQATParameter(description = "mult_desc", name = "mult", minOccurrences = 1, maxOccurrences = 1)
	public void mult(
			@AConQATAttribute(name = "a", description = "a", defaultValue = "pipeline-break")
			@APipelineSource
			String a) {
		// nothing to do here
	}
