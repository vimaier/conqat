 ...
 * @version $Rev: 41751 $
 * @ConQAT.Rating GREEN Hash: 2F1A44F181B7809C263796EB281DA30F
 */
public abstract class XMLReader<E extends Enum<E>, A extends Enum<A>, X extends Exception> {
	...
	public XMLReader(File file, String encoding, URL schemaURL,
			IXMLResolver<E, A> xmlResolver) throws IOException {
		this(FileSystemUtils.streamReader(new FileInputStream(file),
				ensureNotNullEncoding(encoding)), schemaURL, xmlResolver);
	}
	 ...
	 *            resolvers used by this reader
	 */
	public XMLReader(Reader reader, URL schemaURL,
	 ...
	 *            resolvers used by this reader
	 */
	public XMLReader(String content, URL schemaURL,
			IXMLResolver<E, A> xmlResolver) {
