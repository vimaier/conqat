 ...
 * @version $Revision: 46119 $
 * @ConQAT.Rating YELLOW Hash: 4592D1F346EC7D337D88A003EFDD8B2D
 */
public class CollectionUtils {
	...
	/** Converts a list of untyped objects to a list of typed objects */
	@SuppressWarnings("unchecked")
	public static <T> List<T> toTypedList(Collection<?> elements) {
